              ...
              <div className="p-6">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <div className="flex items-center mt-1">
                        ...
                        <span className="text-sm text-gray-500">{agent.location}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center mb-3">
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 text-sm font-medium text-gray-900">{agent.rating}</span>
                    <span className="ml-1 text-sm text-gray-500">({agent.reviewCount} reviews)</span>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  <div className="flex flex-wrap gap-2">
                    ...
                    {agent.specialties.length > 3 && (
                      <span className="text-xs text-gray-500">+{agent.specialties.length - 3} more</span>
                    )}
                  </div>
                </div>
