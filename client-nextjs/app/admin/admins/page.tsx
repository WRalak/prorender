  ...
  const admins = [
    {
      ...
      permissions: ['user_management', 'content_moderation', 'reports'],
      phone: '+1 555-0126',
                  ...
                  <tr key={admin.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getRoleColor(admin.role)}`}>
                        {admin.role.replace('_', ' ').charAt(0).toUpperCase() + admin.role.replace('_', ' ').slice(1)}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full flex items-center gap-1 w-fit ${getStatusColor(admin.status)}`}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <div className="flex flex-wrap gap-1">
                        {admin.permissions.length === 0 ? (
                          ...
                          <span className="px-2 py-1 bg-purple-100 text-purple-800 text-xs rounded-full">All</span>
                        ) : (
                        ...
                        {admin.permissions.length > 2 && admin.permissions[0] !== 'all' && (
                          <span className="text-xs text-gray-500">+{admin.permissions.length - 2}</span>
                        )}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
