...
import { MagnifyingGlassIcon, FunnelIcon, UserPlusIcon, EyeIcon, PencilIcon, TrashIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <div className="space-y-6">
      ...
      <Modal
        ...
        title={modalMode === 'view' ? 'User Details' : modalMode === 'edit' ? 'Update User Status' : ''}
      >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm text-gray-900">
                  {users.find(u => u._id === selectedUser)?.name?.first} {users.find(u => u._id === selectedUser)?.name?.last}
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <StatusBadge status={users.find(u => u._id === selectedUser)?.status} />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">Phone</label>
                <p className="text-sm text-gray-900">
                  {users.find(u => u._id === selectedUser)?.profile?.phone || 'Not provided'}
                </p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">Member Since</label>
                <p className="text-sm text-gray-900">
                  {formatDate(users.find(u => u._id === selectedUser)?.createdAt)}
                </p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">Last Login</label>
                <p className="text-sm text-gray-900">
                  {users.find(u => u._id === selectedUser)?.lastLogin ? formatDate(users.find(u => u._id === selectedUser)?.lastLogin) : 'Never'}
                </p>
              </div>
            </div>
